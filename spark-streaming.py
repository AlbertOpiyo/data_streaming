...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
            ...
            #  .master("local[*]")  # Use local Spark execution with all available cores
             .config("spark.jars.packages",
                     "org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.2")  # Spark-Kafka integration
             .config("spark.jars",
                     "/mnt/c/Users/ADMIN/OneDrive/Desktop/realtimevotingsystem/postgresql-42.7.4.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/mnt/c/Users/ADMIN/OneDrive/Desktop/realtimevotingsystem/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/mnt/c/Users/ADMIN/OneDrive/Desktop/realtimevotingsystem/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
